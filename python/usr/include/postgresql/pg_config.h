...
#define PG_VERSION "15.5 (Debian 15.5-0+deb12u1)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 150005

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 15.5 (Debian 15.5-0+deb12u1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit"
